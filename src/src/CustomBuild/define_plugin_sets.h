...
#ifdef PLUGIN_SET_EP2
#ifndef PLUGIN_DESCR
#define PLUGIN_DESCR "Gosund EP2"
#endif

#define CONTROLLER_SET_STABLE
#define PLUGIN_SET_ONLY_SWITCH
#define NOTIFIER_SET_STABLE
#define USES_P076 // BL0937 in EP2
#define USES_P037 // MQTT Import
#define USES_C005 // OpenHab
#endif
...
#undef USES_BLYNK
#endif
#if !defined(PLUGIN_SET_TESTING) && !defined(PLUGIN_SET_SONOFF_POW) && !defined(PLUGIN_SET_EP2)
#ifdef USES_P076
